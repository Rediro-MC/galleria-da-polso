...
| `galleria-s9-issue-pebbleos.md` | S9-prep · 05/09/2026, verificata e pubblicata il 20/09/2026 | **pubblicata upstream il 20/09/2026 come [coredevices/PebbleOS#2106](https://github.com/coredevices/PebbleOS/issues/2106)** | Analisi del persist di PebbleOS con file e riga, mandata a `coredevices/PebbleOS` su conferma esplicita dell'utente; contiene anche la sezione «Verifica del 20/09/2026» con le sette correzioni alla bozza |
...
| `galleria-s13-ux4-gate-telefono.md` | UX-4 · 14/09/2026, riscritto il 17/09 | **vivo** (utile a release uscita: la 0.4.0 il 18/09/2026 e la 1.0.0 il 20/09/2026 sono uscite senza il gate; il prossimo passo è in `docs/CONTINUA-QUI.md`) | Le venti prove P01–P20 sul telefono vero con la release in store (oggi la 1.0.0), da fare quando l'utente vuole; i risultati vanno in §3, poi in `PIANO.md` §8 |
