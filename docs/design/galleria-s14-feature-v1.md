...
Versione (al 19/09/2026): `package.json` resta **0.4.0** (la release — 0.5.0 o 1.0.0 — è una decisione dell'utente). → **Esito: 1.0.0, pubblicata il 20/09/2026** (record in `apps/galleria/store/PUBLISH.md`, in testa).
