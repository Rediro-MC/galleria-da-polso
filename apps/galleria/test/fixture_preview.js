/* fixture_preview.js - FIXTURE GENERATA da test/gen_preview_fixture.py v1: non modificare a mano.
 ...
 *            rows[]   una riga in A ('12:34'), due in B (HH sopra MM):
...
module.exports = {
  ...
  cases: [
    { platform: 'emery', fmt: 'raw6', font: 'anton', strip: 0, setting: 0, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 200, screen_h: 228, cell: 40, colon: 16, gap: 0, band_h: 106,
    ...
    { platform: 'emery', fmt: 'raw6', font: 'anton', strip: 0, setting: 0, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 200, screen_h: 228, cell: 64, colon: 64, gap: 8, band_h: 228,
    ...
    { platform: 'emery', fmt: 'raw6', font: 'bebas', strip: 1, setting: 1, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 200, screen_h: 228, cell: 40, colon: 16, gap: 0, band_h: 106,
      strip_h: 72, digit_h: 66, ring: 2, shadow: 2, cell_w: 40,
      rows: [
    ...
    { platform: 'emery', fmt: 'raw6', font: 'bebas', strip: 1, setting: 1, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 200, screen_h: 228, cell: 64, colon: 64, gap: 8, band_h: 228,
      strip_h: 100, digit_h: 94, ring: 2, shadow: 2, cell_w: 64,
      rows: [
        { y: 11, total: 136, x0: 32, ring_gap: 2, glyphs: [
    ...
    { platform: 'emery', fmt: 'raw6', font: 'barlow', strip: 2, setting: 2, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 200, screen_h: 228, cell: 40, colon: 16, gap: 0, band_h: 106,
    ...
    { platform: 'emery', fmt: 'raw6', font: 'barlow', strip: 2, setting: 2, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 200, screen_h: 228, cell: 64, colon: 64, gap: 8, band_h: 228,
    ...
    { platform: 'emery', fmt: 'raw6', font: 'francois', strip: 3, setting: 4, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 200, screen_h: 228, cell: 40, colon: 16, gap: 0, band_h: 106,
      strip_h: 72, digit_h: 61, ring: 2, shadow: 2, cell_w: 40,
      rows: [
    ...
    { platform: 'emery', fmt: 'raw6', font: 'francois', strip: 3, setting: 4, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 200, screen_h: 228, cell: 64, colon: 64, gap: 8, band_h: 228,
      strip_h: 100, digit_h: 94, ring: 2, shadow: 2, cell_w: 64,
      rows: [
    ...
    { platform: 'emery', fmt: 'raw6', font: 'staatliches', strip: 4, setting: 5, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 200, screen_h: 228, cell: 40, colon: 16, gap: 0, band_h: 106,
    ...
    { platform: 'emery', fmt: 'raw6', font: 'staatliches', strip: 4, setting: 5, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 200, screen_h: 228, cell: 64, colon: 64, gap: 8, band_h: 228,
      strip_h: 100, digit_h: 94, ring: 2, shadow: 2, cell_w: 64,
      rows: [
        { y: 11, total: 136, x0: 32, ring_gap: 2, glyphs: [
    ...
    { platform: 'flint', fmt: 'raw1', font: 'anton', strip: 0, setting: 0, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 144, screen_h: 168, cell: 28, colon: 12, gap: 0, band_h: 76,
    ...
    { platform: 'flint', fmt: 'raw1', font: 'anton', strip: 0, setting: 0, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 144, screen_h: 168, cell: 48, colon: 48, gap: 8, band_h: 168,
    ...
    { platform: 'flint', fmt: 'raw1', font: 'bebas', strip: 1, setting: 1, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 144, screen_h: 168, cell: 28, colon: 12, gap: 0, band_h: 76,
      strip_h: 44, digit_h: 42, ring: 1, shadow: 0, cell_w: 28,
      rows: [
        { y: 6, total: 124, x0: 10, ring_gap: 2, glyphs: [
    ...
    { platform: 'flint', fmt: 'raw1', font: 'bebas', strip: 1, setting: 1, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 144, screen_h: 168, cell: 48, colon: 48, gap: 8, band_h: 168,
      strip_h: 64, digit_h: 62, ring: 1, shadow: 0, cell_w: 48,
      rows: [
        { y: 12, total: 104, x0: 20, ring_gap: 2, glyphs: [
    ...
    { platform: 'flint', fmt: 'raw1', font: 'barlow', strip: 2, setting: 2, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 144, screen_h: 168, cell: 28, colon: 12, gap: 0, band_h: 76,
    ...
    { platform: 'flint', fmt: 'raw1', font: 'barlow', strip: 2, setting: 2, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 144, screen_h: 168, cell: 48, colon: 48, gap: 8, band_h: 168,
      strip_h: 64, digit_h: 62, ring: 1, shadow: 0, cell_w: 48,
      rows: [
        { y: 12, total: 104, x0: 20, ring_gap: 2, glyphs: [
    ...
    { platform: 'flint', fmt: 'raw1', font: 'francois', strip: 3, setting: 4, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 144, screen_h: 168, cell: 28, colon: 12, gap: 0, band_h: 76,
    ...
    { platform: 'flint', fmt: 'raw1', font: 'francois', strip: 3, setting: 4, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 144, screen_h: 168, cell: 48, colon: 48, gap: 8, band_h: 168,
    ...
    { platform: 'flint', fmt: 'raw1', font: 'staatliches', strip: 4, setting: 5, layout: 'A', size: 'a', mode: 'A_SPRITE',
      screen_w: 144, screen_h: 168, cell: 28, colon: 12, gap: 0, band_h: 76,
      strip_h: 44, digit_h: 42, ring: 1, shadow: 0, cell_w: 28,
      rows: [
    ...
    { platform: 'flint', fmt: 'raw1', font: 'staatliches', strip: 4, setting: 5, layout: 'B', size: 'b', mode: 'B_SPRITE',
      screen_w: 144, screen_h: 168, cell: 48, colon: 48, gap: 8, band_h: 168,
      strip_h: 64, digit_h: 62, ring: 1, shadow: 0, cell_w: 48,
      rows: [
        { y: 12, total: 104, x0: 20, ring_gap: 2, glyphs: [
  ...
  photos: [
    { name: 'demo_1', platform: 'emery', fmt: 'raw6', file: 'demo_1.raw6', bytes: 34200, crc: 0x2B7BE24F, w: 200, h: 228,
      bands: [
        { layout: 'A', h: 106, samples: 5300, bad_white: 0, bad_black: 96, mean: 15, white: true, bad_pct: 0, halo: false },
        { layout: 'B', h: 228, samples: 11400, bad_white: 1, bad_black: 92, mean: 19, white: true, bad_pct: 1, halo: false },
      ] },
    { name: 'demo_1', platform: 'flint', fmt: 'raw1', file: 'demo_1.raw1', bytes: 3024, crc: 0xA35A8FE7, w: 144, h: 168,
      bands: [
        { layout: 'A', h: 76, samples: 2736, bad_white: 21, bad_black: 78, mean: 54, white: true, bad_pct: 21, halo: true },
        { layout: 'B', h: 168, samples: 6048, bad_white: 22, bad_black: 77, mean: 57, white: true, bad_pct: 22, halo: true },
      ] },
    { name: 'demo_2', platform: 'emery', fmt: 'raw6', file: 'demo_2.raw6', bytes: 34200, crc: 0xC91AE01B, w: 200, h: 228,
      bands: [
        { layout: 'A', h: 106, samples: 5300, bad_white: 95, bad_black: 0, mean: 134, white: false, bad_pct: 0, halo: false },
        { layout: 'B', h: 228, samples: 11400, bad_white: 84, bad_black: 6, mean: 133, white: false, bad_pct: 6, halo: false },
      ] },
    { name: 'demo_2', platform: 'flint', fmt: 'raw1', file: 'demo_2.raw1', bytes: 3024, crc: 0xA7EF19B1, w: 144, h: 168,
      bands: [
        { layout: 'A', h: 76, samples: 2736, bad_white: 86, bad_black: 13, mean: 221, white: false, bad_pct: 13, halo: true },
        { layout: 'B', h: 168, samples: 6048, bad_white: 76, bad_black: 23, mean: 195, white: false, bad_pct: 23, halo: true },
      ] },
  ]
};
