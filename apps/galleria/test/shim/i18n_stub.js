 ...
 * es, pt } (S11/D39: es e pt in coda), array paralleli nell'ordine delle chiavi — con tre chiavi
 * e un segnaposto {0}, e accenti veri (i testi non finiscono mai in un log: F-S8-2). */
module.exports = {
  ...
  pt: ['Salvar', 'Adicionar foto', 'Fotos: {0}']
};
